      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto backdrop-blur-lg bg-black/30 rounded-xl p-8 border border-gray-700 shadow-2xl">
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
            This Privacy Policy describes how and its affiliates us to collect,
            use, share, protect or otherwise process your information/ personal
            data through our website TEDxIIITSricity(hereinafter referred to as
            Platform). Please note that you may be able to browse certain
            sections of the Platform without registering with us. We do not
            ...
            agree please do not use or access our Platform.Collection-We collect
            ...
            feature on the Platform. We may track your behaviour, preferences,
            ...
            not be responsible for the thirdparty business partner’s privacy
            ...
            law enforcement agency.Usage- We use personal data to provide the
            ...
            uses. We use your personal data to assist sellers and business
            partners 1 in handling and fulfilling orders; enhancing customer
            ...
            affected in the event permission is not provided to us.Sharing- We
            may share your personal data internally within our group entities,
            our other corporate entities, and affiliates to provide you access
            to the services and products offered by them. These entities and
            ...
            under any applicable law. However, we may retain data related to 2
            ...
            purposes.Your Rights- You may access, rectify, and update your
            personal data directly through the functionalities provided on the
            Platform. Consent- By visiting our Platform or by providing your
            information, you consent to the collection, use, storage, disclosure
            and otherwise processing of your information on the Platform in
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
            ...
            as applicable to the Platform including the applicable policies
            ...
            purpose that is unlawful, illegal or 4 forbidden by these Terms, or
            ...
            consequential, incidental, special or punitive damages, 4 including
